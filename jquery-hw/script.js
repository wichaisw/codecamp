...
$(document).ready(function() {
  ...
  $(".fb-feed-wrapper").on("click", ".like-button", function() {
    ...
    if ($(this).attr("class") == "like-button blue-liked-button") {
      ...
      likeCounterDisplay.html(`${totalLike}`);
